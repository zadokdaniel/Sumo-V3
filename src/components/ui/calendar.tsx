  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-purple-900 text-slate-50 hover:bg-purple-900 hover:text-slate-50 focus:bg-purple-900 focus:text-slate-50 dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50 dark:hover:text-slate-900 dark:focus:bg-slate-50 dark:focus:text-slate-900",
